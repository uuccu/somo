import 'package:agile_frontend/page/finding_roommate/finding_roommate_condition3.dart';
...
class FindingRoommateConditionPage2 extends StatelessWidget {
  @override
        ...
        child: Column(
          ...
          children: [
            ...
            const LifestyleOptionCard(
              ...
              emoji: '🌞',
              description:
                  "I wake up early to start my day and go to bed before it gets late.",
            ),
            ...
            const LifestyleOptionCard(
              ...
              emoji: '🌛',
              description:
                  "I wake up a bit later and engage in activities or work into the evening. ",
            ),
            const Spacer(),
            const Text(
            ...
            Row(
              ...
              children: [
                ...
                OutlinedButton(
                  onPressed: () {
                    Get.to(FindingRoommateConditionPage3());
                  },
                  style: ButtonStyle(
                    fixedSize: MaterialStateProperty.all<Size>(Size(
                      Screen.designToScreenWidth(context, 180),
